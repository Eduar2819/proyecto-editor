...
var _Camera_principal = new THREE.PerspectiveCamera( 50, 1, 0.01, 1000 );
_Camera_principal.name = 'Camera';
_Camera_principal.position.set(0, 5, 10);
_Camera_principal.lookAt( new THREE.Vector3() );
...
function Editor() {
	...
	this.camera = _Camera_principal.clone();
